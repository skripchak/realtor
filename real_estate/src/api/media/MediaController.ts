...
const uploads: Multer = multer({ dest: 'storage' });
...
class MediaController {
    ...
    static getMediaFile(req: Request, res: Response, next: NextFunction) {
    ...
    static async getAllMediaByPremissesId(req: Request, res: Response, next: NextFunction) {
        const { id } = req.params;
    ...
    static async getAllMediaByRealtorId(req: Request, res: Response, next: NextFunction) {
        const { id } = req.params;
    ...
    static async getAllMediaByUserId(req: Request, res: Response, next: NextFunction) {
        const { id } = req.params;
    ...
    static async createMedia(req: MulterRequest, res: Response, next: NextFunction) {
        if (req.file) {
