...
class PremissesController {
    static async getAllPremisses(req: Request, res: Response) {
        try {
    ...
    static async getPremissesById(req: Request, res: Response) {
        const { id } = req.params;
        try {
    ...
    static async createPremisses(req: Request, res: Response) {
    ...
    static async updatePremisses(req: Request, res: Response) {
        const { id } = req.params;
        const { premisses_type_id, realtor_id, name, renttype, description, address, room_number, floor, square, area_description, price, isposted, available, is_verificated } = req.body;
        try {
    ...
    static async deletePremisses(req: Request, res: Response) {
        const { id } = req.params;
        try {
