...
class RealtorController {
    static async getAllRealtors(req, res) {
        try {
    ...
    static async getRealtorById(req, res) {
        const { id } = req.params;
        try {
    ...
    static async getRealtorByName(req, res) {
    ...
    static async createRealtor(req, res) {
    ...
    static async updateRealtor(req, res) {
        const { id } = req.params;
        const { name, location, phone_number } = req.body;
        try {
    ...
    static async deleteRealtor(req, res) {
        const { id } = req.params;
        try {
