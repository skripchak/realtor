        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="mt-10 lg:mt-0 lg:mx-10">
            ...
            <h1 className="font-Poppins text-blue font-bold text-2xl py-2">
              Ваш комфорт – це наш Рівняк
            </h1>
            <p className="font-Poppins text-ash mb-4">
              Ми фірма рівна, допоки стоїмо на рівній землі. Все завжди ок, ще ніхто не скаржився, хіба що отой, забув ну як будете йти на надгробку прочитаєте
            </p>
            <div className="flex mt-2">
              <div className=" pr-5">
                <h2 className="flex items-center text-ash mb-2">
                  <MdOutlineRemoveCircle className="text-blue mr-2" /> Views це
                  рахувати
                </h2>
              ...
              <div>
                <h2 className="flex items-center text-ash mb-2">
                  <MdOutlineRemoveCircle className="text-blue mr-2" /> Халявний
                  Маркетинг
                </h2>
                <h2 className="flex items-center text-ash">
                  <MdOutlineRemoveCircle className="text-blue mr-2" />
                  Переглянуті всі мутки
                </h2>
              </div>
            </div>
            <div className=" pt-6">
              <button className=" bg-blue text-white font-bold text-md px-8 py-3 rounded-lg shadow-lg">
                <a href="/listings">Більше поглазіти</a>
              </button>
            </div>
          </div>
        </div>
